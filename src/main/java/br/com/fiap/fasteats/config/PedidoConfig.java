...
public class PedidoConfig {
    @Bean
    public PedidoUseCase crudPedidoUseCase(PedidoAdapter pedidoAdapter, PedidoValidatorImpl pedidoValidatorImpl) {
        return new PedidoUseCase(pedidoAdapter,  pedidoValidatorImpl);
    }
}
